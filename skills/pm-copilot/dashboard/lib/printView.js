...
/**
 * Genera el HTML de solo lectura para /print (y por tanto para el PDF).
 ...
 * consume el dashboard interactivo (el snapshot de buildSnapshot).
 */
...
module.exports = { renderPrintView };
