...
| ID | Título | Descripción | Impacto | Coste | Alcance | Plazo | Calidad | Decisión | Riesgos generados | Dependencias generadas | Acciones generadas | Comentarios | Visibilidad | Motivo (descarte/eliminación) | Última modificación | Modificado por |
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
