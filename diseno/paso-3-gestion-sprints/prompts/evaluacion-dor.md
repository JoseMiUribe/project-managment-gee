...
1. Carga el `dor-definition.md` del proyecto (en `[proyecto]/config/dor-definition.md`)
...
Genera `sprint-candidates.md` con:
...
5. Recomendación de cuántas HU llevar al sprint según capacidad-equipo.md
