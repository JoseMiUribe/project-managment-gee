...
**Propósito:** Definir la Definition of Ready y Definition of Done del proyecto, personalizadas para el equipo y el contexto. Se ejecuta después de tener las épicas y antes de calcular la capacidad del equipo, porque el DoD impacta en el esfuerzo por HU.
...
1. `config/dor-definition.md` con los criterios acordados
2. `config/dod-definition.md` con los criterios acordados

Usa los templates base de `diseno/paso-3-gestion-sprints/templates/` como estructura, pero personaliza según las respuestas.
...
Factores de impacto del DoD en la capacidad:
...
Estos son valores de referencia. El prompt de capacidad los usará para ajustar la velocidad.

### Modo Plantilla

Si el PM elige plantilla, entrégale los templates base:
- `diseno/paso-3-gestion-sprints/templates/dor-definition.md`
- `diseno/paso-3-gestion-sprints/templates/dod-definition.md`
