...
> **Confianza global:** [Alta / Media / Baja — basado en capacidad-equipo.md y riesgos GEE]
...
2. **[Condición 2]** — ej: El equipo se mantiene con la composición actual
...
- Cambia el equipo (altas, bajas, reducción de dedicación)
...
> **Nota para el PM:** Este documento se genera automáticamente desde épicas + capacidad-equipo.md + GEE. No lo edites manualmente; si necesitas cambios, actualiza los inputs y regenera.
