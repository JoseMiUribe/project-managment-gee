...
> **Fecha:** [YYYY-MM-DD]
> **Basado en:** capacidad-equipo.md V[XX]
...
| R-009: Cloudflare no aprobado | HU-009 se mueve a Sprint 4 | Alternativa: implementar RAG básico sin UE |
| R-013: Contraste WCAG en escala | Sprint 1 +2 días | Validación temprana en Sprint 1 |
...
| Fecha | Qué se revisa |
|---|---|
| [Fin Sprint 1] | Velocidad real vs estimada → recalcular capacidad V2 |
| [Fin Sprint 2] | Dependencias externas → actualizar roadmap |
| [Fecha] | Revisión con cliente → ajustar prioridades |

---

> **Nota para el PM:** Este documento se regenera automáticamente. No lo edites manualmente. Los cambios se hacen en épicas, capacidad-equipo.md o GEE.
